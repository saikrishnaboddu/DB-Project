    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (restId.getText().equals("")) {
                    Toast.makeText(getActivity(), "Please Enter Restaurant ID", Toast.LENGTH_LONG).show();

                } else {
                    boolean ins = dbm.insertRecord("", "", 0, Integer.parseInt(restId.getText().toString()));
                    if (ins) {
